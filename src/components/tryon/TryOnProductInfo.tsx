  ...
  return (
    <div className="rounded-2xl p-6 space-y-5 relative overflow-hidden" style={{ backgroundImage: `url(${bgShowroom})`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
      ...
      <div>
        ...
        <p className="font-body text-3xl font-bold text-foreground mt-2 font-mono">{necklace.priceDisplay}</p>
      </div>
      <div className="flex items-center gap-2">
        ...
        <span className="font-body text-sm font-semibold text-foreground font-mono">4.8</span>
        <span className="font-body text-sm text-muted-foreground font-mono">(125 đánh giá)</span>
      </div>
      <div>
