      ...
      <div className="absolute inset-0 flex items-center">
        <div className="container mx-auto px-4 md:px-16 flex flex-col md:flex-row items-center justify-between gap-8">
          <div
            ...
            <h1 className="font-display text-4xl lg:text-7xl text-primary-foreground leading-[1.2] whitespace-pre-line md:text-6xl font-extrabold mx-0 px-0 font-serif">
