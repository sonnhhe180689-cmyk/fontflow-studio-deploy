      ...
      <section className="relative w-full h-[70vh] md:h-[80vh] overflow-hidden">
        ...
        <div className="absolute bottom-8 left-0 right-0">
          <div className="container mx-auto px-4 md:px-16 flex gap-12">
            <div>
              <p className="font-display text-2xl font-bold text-primary md:text-2xl font-mono">24/7</p>
              <p className="font-body text-xs text-primary-foreground/70">Hỗ Trợ Khách Hàng</p>
            </div>
            <div>
              <p className="font-display text-2xl font-bold text-primary md:text-2xl font-mono">7 Ngày</p>
              <p className="font-body text-xs text-primary-foreground/70">Miễn Phí Đổi Trả</p>
            </div>
            <div>
              <p className="font-display text-2xl font-bold text-primary md:text-2xl font-mono">5<Star className="w-4 h-4 inline text-primary ml-0.5 -mt-1" /></p>
      ...
      <section id="collections-grid" className="py-20 bg-cream">
        <div className="container mx-auto px-4">
          <div className="text-center mb-10">
            ...
            <p className="font-body text-muted-foreground mt-4 max-w-xl mx-auto text-xl my-[12px]">
          ...
          <div key={col.id} className="min-w-0 shrink-0 grow-0 basis-1/2 md:basis-1/4 pl-4">
              <div className="group cursor-pointer">
                ...
                <div className="mt-4 text-center">
                  ...
                  <p className="font-body text-primary font-medium mt-1 font-mono text-base">{col.priceDisplay}</p>
