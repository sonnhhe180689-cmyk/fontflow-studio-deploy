      ...
      <section className="relative h-[60vh] overflow-hidden">
        ...
        <div className="absolute inset-0 bg-foreground/60 flex items-center justify-center">
          <div className="text-center">
            <h2 className="font-heading text-4xl md:text-5xl text-primary-foreground font-bold">Nghệ Thuật Chế Tác Vòng Cổ</h2>
          ...
          <div key={product.id} className="min-w-0 shrink-0 grow-0 basis-1/2 md:basis-1/4 pl-4">
              <div className="group cursor-pointer">
                ...
                <div className="mt-4 text-center">
                  ...
                  <p className="font-body text-primary font-medium mt-1 font-mono text-base">{product.priceDisplay}</p>
